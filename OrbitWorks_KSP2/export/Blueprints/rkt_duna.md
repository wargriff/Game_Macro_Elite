...
**OrbitWorks ID:** `rkt_duna`
**Catégorie:** rockets
**Type / sous-type:** rocket / interplanetary
**Destination:** Duna
**Masse estimée:** 64.735 t
...
|----:|-------------------|------------|------|----------------:|
| 1 | Mk1 Conical Command Pod | `pod_1v_conical_crew` | core | 0.840 |
| 1 | Mk16 Parachute | `parachute_mk16` | reentry | 0.100 |
| 1 | Heat Shield (1.25m) | `heatshield_1v` | reentry | 0.300 |
| 1 | HG-55 | `antenna_hg55` | comms | 0.075 |
| 1 | Gigantor XL Solar Array | `panel_gigantor` | power | 0.300 |
| 1 | LV-N Nerv | `engine_1v_nuclear_nerv` | cruise | 3.000 |
| 4 | FL-T800 | `fueltank_1v_inline_methalox_1x8` | cruise | 18.000 |
...
### reentry
- [ ] ×1 **Mk16 Parachute** (`parachute_mk16`)
...
### cruise
- [ ] ×1 **LV-N Nerv** (`engine_1v_nuclear_nerv`)
