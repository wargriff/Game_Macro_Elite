...
**OrbitWorks ID:** `rkt_duna_ascent`
**Catégorie:** rockets
**Type / sous-type:** rocket / lander
**Destination:** Duna
**Masse estimée:** 53.035 t
...
| 1 | LV-909 Terrier | `engine_1v_methalox_terrier` | cruise | 0.500 |
| 2 | FL-T800 | `fueltank_1v_inline_methalox_1x8` | cruise | 9.000 |
...
Taxi remontée Duna vers orbite.
