# Starship-K Orbital Depot

**OrbitWorks ID:** `rkt_ss_depot`
**Catégorie:** starship
**Type / sous-type:** rocket / starship
**Destination:** Kerbin LEO
**Masse estimée:** 897.975 t
...
| 1 | S3 KS-25x4 / Rhino-class | `engine_3v_methalox_rhino` | ship | 9.000 |
...
- [ ] ×1 **S3 KS-25x4 / Rhino-class** (`engine_3v_methalox_rhino`)
