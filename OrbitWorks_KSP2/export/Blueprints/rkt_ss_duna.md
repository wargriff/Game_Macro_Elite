# Starship-K Duna Transport

**OrbitWorks ID:** `rkt_ss_duna`
**Catégorie:** starship
**Type / sous-type:** rocket / starship
**Destination:** Duna
**Masse estimée:** 924.475 t
**Δv estimé (indicatif):** ~7000 m/s
**Tags:** starship, duna
...
| 1 | Starship-K Crew Cabin | `body_starship_crew` | ship | 8.500 |
| 1 | Starship-K Cargo Bay | `body_starship_cargo` | ship | 4.000 |
| 4 | Starship-K Elevon | `wing_starship_flap` | ship | 1.400 |
| 6 | Starship-K Catch / Landing Leg | `landingleg_starship` | ship | 2.400 |
| 8 | RV-105 RCS Thruster Block | `rcs_rv105` | ship | 0.400 |
| 2 | Gigantor XL Solar Array | `panel_gigantor` | ship | 0.600 |
| 2 | Z-4k Battery | `battery_z4k` | ship | 0.400 |
| 1 | HG-55 | `antenna_hg55` | ship | 0.075 |
| 3 | S3 KS-25x4 / Rhino-class | `engine_3v_methalox_rhino` | ship | 27.000 |
| 3 | S4-25600 | `fueltank_3v_inline_methalox_1x8` | ship | 432.000 |
...
- [ ] ×1 **Starship-K Crew Cabin** (`body_starship_crew`)
- [ ] ×1 **Starship-K Cargo Bay** (`body_starship_cargo`)
- [ ] ×4 **Starship-K Elevon** (`wing_starship_flap`)
- [ ] ×6 **Starship-K Catch / Landing Leg** (`landingleg_starship`)
- [ ] ×8 **RV-105 RCS Thruster Block** (`rcs_rv105`)
- [ ] ×2 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×2 **Z-4k Battery** (`battery_z4k`)
- [ ] ×1 **HG-55** (`antenna_hg55`)
- [ ] ×3 **S3 KS-25x4 / Rhino-class** (`engine_3v_methalox_rhino`)
- [ ] ×3 **S4-25600** (`fueltank_3v_inline_methalox_1x8`)
