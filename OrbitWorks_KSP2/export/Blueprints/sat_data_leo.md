...
| 1 | 48-7S Spark | `engine_1v_methalox_spark` | upper | 0.130 |
| 1 | FL-T100 | `fueltank_1v_inline_methalox_1x1` | upper | 0.562 |
| 1 | TR-18A Stack Decoupler | `decoupler_1v_stack` | stage | 0.040 |
| 1 | LV-T45 Swivel | `engine_1v_methalox_swivel` | booster | 1.500 |
| 2 | FL-T400 | `fueltank_1v_inline_methalox_1x4` | booster | 4.500 |

## Par rôle (rapide VAB)

### core
- [ ] ×1 **Probodobodyne QBE** (`probe_1v_cube`)
...
- [ ] ×1 **PresMat Barometer** (`science_barometer`)
...
### upper
- [ ] ×1 **48-7S Spark** (`engine_1v_methalox_spark`)
- [ ] ×1 **FL-T100** (`fueltank_1v_inline_methalox_1x1`)
