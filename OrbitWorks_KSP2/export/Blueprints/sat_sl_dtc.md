# Starlink Direct-to-Cell ×12

**OrbitWorks ID:** `sat_sl_dtc`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin LEO
**Masse estimée:** 99.270 t
...
| 12 | Starlink-K Direct-to-Cell | `payload_starlink_dtc` | sat | 4.800 |
| 12 | Gigantor XL Solar Array | `panel_gigantor` | sat | 3.600 |
| 12 | HG-55 | `antenna_hg55` | sat | 0.900 |
...
### sat
- [ ] ×12 **Starlink-K Direct-to-Cell** (`payload_starlink_dtc`)
- [ ] ×12 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×12 **HG-55** (`antenna_hg55`)
