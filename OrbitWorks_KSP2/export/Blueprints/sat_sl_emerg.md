# Starlink Emergency Mesh ×16

**OrbitWorks ID:** `sat_sl_emerg`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin Polaire
**Masse estimée:** 124.210 t
**Δv estimé (indicatif):** ~3600 m/s
**Tags:** starlink, emergency
...
| 16 | Starlink-K Direct-to-Cell | `payload_starlink_dtc` | sat | 6.400 |
| 16 | Gigantor XL Solar Array | `panel_gigantor` | sat | 4.800 |
| 16 | HG-5 High Gain Antenna | `antenna_hg5` | sat | 1.120 |
| 16 | Probodobodyne OKTO | `probe_1v_octo` | sat | 1.600 |
| 16 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.080 |
...
### sat
- [ ] ×16 **Starlink-K Direct-to-Cell** (`payload_starlink_dtc`)
- [ ] ×16 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×16 **HG-5 High Gain Antenna** (`antenna_hg5`)
- [ ] ×16 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×16 **Z-100 Rechargeable Battery** (`battery_z100`)
