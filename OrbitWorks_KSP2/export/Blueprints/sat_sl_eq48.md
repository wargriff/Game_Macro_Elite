# Starlink Equatorial ×48

**OrbitWorks ID:** `sat_sl_eq48`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin LEO
**Masse estimée:** 104.470 t
...
| 48 | Starlink-K Flat Bus | `payload_starlink_bus` | sat | 12.480 |
| 8 | Gigantor XL Solar Array | `panel_gigantor` | sat | 2.400 |
| 8 | Communotron 16 | `antenna_comm16` | sat | 0.040 |
...
### sat
- [ ] ×48 **Starlink-K Flat Bus** (`payload_starlink_bus`)
- [ ] ×8 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×8 **Communotron 16** (`antenna_comm16`)
...
Plan équatorial Kerbin pour couverture tropiques.
