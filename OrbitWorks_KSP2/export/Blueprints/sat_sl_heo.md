# Starlink HEO Guard ×6

**OrbitWorks ID:** `sat_sl_heo`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin HEO
**Masse estimée:** 121.340 t
**Δv estimé (indicatif):** ~5000 m/s
**Tags:** starlink, heo
...
| 6 | Starlink-K Direct-to-Cell | `payload_starlink_dtc` | sat | 2.400 |
| 6 | Gigantor XL Solar Array | `panel_gigantor` | sat | 1.800 |
| 6 | RA-15 Relay Antenna | `antenna_ra15` | sat | 1.800 |
| 6 | Probodobodyne OKTO | `probe_1v_octo` | sat | 0.600 |
| 6 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.030 |
...
### sat
- [ ] ×6 **Starlink-K Direct-to-Cell** (`payload_starlink_dtc`)
- [ ] ×6 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×6 **RA-15 Relay Antenna** (`antenna_ra15`)
- [ ] ×6 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×6 **Z-100 Rechargeable Battery** (`battery_z100`)
