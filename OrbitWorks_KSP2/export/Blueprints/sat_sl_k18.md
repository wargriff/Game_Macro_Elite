...
| 18 | Starlink-K Flat Bus | `payload_starlink_bus` | sat | 4.680 |
| 18 | Gigantor XL Solar Array | `panel_gigantor` | sat | 5.400 |
| 18 | Communotron 16 | `antenna_comm16` | sat | 0.090 |
| 18 | Probodobodyne OKTO | `probe_1v_octo` | sat | 1.800 |
| 18 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.090 |
...
### sat
- [ ] ×18 **Starlink-K Flat Bus** (`payload_starlink_bus`)
- [ ] ×18 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×18 **Communotron 16** (`antenna_comm16`)
- [ ] ×18 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×18 **Z-100 Rechargeable Battery** (`battery_z100`)
