...
|----:|-------------------|------------|------|----------------:|
| 1 | Constellation Dispenser x48 | `payload_dispenser_48` | payload | 1.100 |
| 48 | Starlink-K V2 Bus | `payload_starlink_v2` | sat | 15.360 |
| 48 | Gigantor XL Solar Array | `panel_gigantor` | sat | 14.400 |
| 48 | HG-5 High Gain Antenna | `antenna_hg5` | sat | 3.360 |
| 48 | Probodobodyne OKTO | `probe_1v_octo` | sat | 4.800 |
| 48 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.240 |
...
### payload
- [ ] ×1 **Constellation Dispenser x48** (`payload_dispenser_48`)

### sat
- [ ] ×48 **Starlink-K V2 Bus** (`payload_starlink_v2`)
- [ ] ×48 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×48 **HG-5 High Gain Antenna** (`antenna_hg5`)
- [ ] ×48 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×48 **Z-100 Rechargeable Battery** (`battery_z100`)
