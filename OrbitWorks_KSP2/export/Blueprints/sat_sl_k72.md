# Starlink Shell Dense ×72

**OrbitWorks ID:** `sat_sl_k72`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin LEO
**Masse estimée:** 112.350 t
...
| 72 | Starlink-K Flat Bus | `payload_starlink_bus` | sat | 18.720 |
| 12 | Gigantor XL Solar Array | `panel_gigantor` | sat | 3.600 |
| 12 | Communotron 16 | `antenna_comm16` | sat | 0.060 |
| 12 | Probodobodyne OKTO | `probe_1v_octo` | sat | 1.200 |
| 12 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.060 |
...
### sat
- [ ] ×72 **Starlink-K Flat Bus** (`payload_starlink_bus`)
- [ ] ×12 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×12 **Communotron 16** (`antenna_comm16`)
- [ ] ×12 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×12 **Z-100 Rechargeable Battery** (`battery_z100`)
...
Shell dense LEO — reconstruction VAB multi-vols.
