# Starlink Mega Plane ×96

**OrbitWorks ID:** `sat_sl_k96`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin LEO
**Masse estimée:** 120.230 t
...
| 96 | Starlink-K Flat Bus | `payload_starlink_bus` | sat | 24.960 |
| 16 | Gigantor XL Solar Array | `panel_gigantor` | sat | 4.800 |
| 16 | Communotron 16 | `antenna_comm16` | sat | 0.080 |
...
### sat
- [ ] ×96 **Starlink-K Flat Bus** (`payload_starlink_bus`)
- [ ] ×16 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×16 **Communotron 16** (`antenna_comm16`)
...
Plan orbital saturé — à lancer en plusieurs rideshares.
