# Starlink Laser Test ×6

**OrbitWorks ID:** `sat_sl_laser`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin LEO
**Masse estimée:** 93.510 t
...
| 6 | Starlink-K V2 Bus | `payload_starlink_v2` | sat | 1.920 |
| 6 | Gigantor XL Solar Array | `panel_gigantor` | sat | 1.800 |
| 6 | HG-55 | `antenna_hg55` | sat | 0.450 |
...
### sat
- [ ] ×6 **Starlink-K V2 Bus** (`payload_starlink_v2`)
- [ ] ×6 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×6 **HG-55** (`antenna_hg55`)
