# Starlink MEO Bridge ×8

**OrbitWorks ID:** `sat_sl_meo`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin MEO
**Masse estimée:** 122.910 t
**Δv estimé (indicatif):** ~4500 m/s
**Tags:** starlink, meo
...
| 8 | Starlink-K V2 Bus | `payload_starlink_v2` | sat | 2.560 |
| 8 | Gigantor XL Solar Array | `panel_gigantor` | sat | 2.400 |
| 8 | RA-15 Relay Antenna | `antenna_ra15` | sat | 2.400 |
| 8 | Probodobodyne OKTO | `probe_1v_octo` | sat | 0.800 |
| 8 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.040 |
...
### sat
- [ ] ×8 **Starlink-K V2 Bus** (`payload_starlink_v2`)
- [ ] ×8 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×8 **RA-15 Relay Antenna** (`antenna_ra15`)
- [ ] ×8 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×8 **Z-100 Rechargeable Battery** (`battery_z100`)
