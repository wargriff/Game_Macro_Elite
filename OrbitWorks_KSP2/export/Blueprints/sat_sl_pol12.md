...
| 12 | Starlink-K Flat Bus | `payload_starlink_bus` | sat | 3.120 |
| 12 | Gigantor XL Solar Array | `panel_gigantor` | sat | 3.600 |
| 12 | HG-5 High Gain Antenna | `antenna_hg5` | sat | 0.840 |
...
### sat
- [ ] ×12 **Starlink-K Flat Bus** (`payload_starlink_bus`)
- [ ] ×12 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×12 **HG-5 High Gain Antenna** (`antenna_hg5`)
