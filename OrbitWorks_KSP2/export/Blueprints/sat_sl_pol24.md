# Starlink Polar Mesh ×24

**OrbitWorks ID:** `sat_sl_pol24`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin Polaire
**Masse estimée:** 129.290 t
...
| 24 | Starlink-K V2 Bus | `payload_starlink_v2` | sat | 7.680 |
| 24 | Gigantor XL Solar Array | `panel_gigantor` | sat | 7.200 |
| 24 | HG-5 High Gain Antenna | `antenna_hg5` | sat | 1.680 |
| 24 | Probodobodyne OKTO | `probe_1v_octo` | sat | 2.400 |
| 24 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.120 |
...
### sat
- [ ] ×24 **Starlink-K V2 Bus** (`payload_starlink_v2`)
- [ ] ×24 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×24 **HG-5 High Gain Antenna** (`antenna_hg5`)
- [ ] ×24 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×24 **Z-100 Rechargeable Battery** (`battery_z100`)
