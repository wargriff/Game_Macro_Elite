# Starlink Polar Heavy ×48

**OrbitWorks ID:** `sat_sl_pol48`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin Polaire
**Masse estimée:** 174.910 t
**Δv estimé (indicatif):** ~3600 m/s
**Tags:** starlink, polar
...
| 48 | HG-55 | `antenna_hg55` | sat | 3.600 |
...
### boosters
- [ ] ×4 **S1 SRB Kickback** (`engine_srf_kickback`)
