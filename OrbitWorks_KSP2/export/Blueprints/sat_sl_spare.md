# Starlink Spare Rack ×20

**OrbitWorks ID:** `sat_sl_spare`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin LEO
**Masse estimée:** 102.110 t
...
| 20 | Starlink-K Flat Bus | `payload_starlink_bus` | sat | 5.200 |
| 20 | Gigantor XL Solar Array | `panel_gigantor` | sat | 6.000 |
| 20 | Communotron 16 | `antenna_comm16` | sat | 0.100 |
| 20 | Probodobodyne OKTO | `probe_1v_octo` | sat | 2.000 |
| 20 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.100 |
...
### sat
- [ ] ×20 **Starlink-K Flat Bus** (`payload_starlink_bus`)
- [ ] ×20 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×20 **Communotron 16** (`antenna_comm16`)
- [ ] ×20 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×20 **Z-100 Rechargeable Battery** (`battery_z100`)
