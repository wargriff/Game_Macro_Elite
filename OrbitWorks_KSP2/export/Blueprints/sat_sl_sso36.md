# Starlink SSO Dense ×36

**OrbitWorks ID:** `sat_sl_sso36`
**Catégorie:** starlink
**Type / sous-type:** satellite / starlink
**Destination:** Kerbin SSO
**Masse estimée:** 143.530 t
**Δv estimé (indicatif):** ~3700 m/s
**Tags:** starlink, sso
...
|----:|-------------------|------------|------|----------------:|
| 1 | Constellation Dispenser x36 | `payload_dispenser_36` | payload | 1.000 |
| 36 | Starlink-K V2 Bus | `payload_starlink_v2` | sat | 11.520 |
| 36 | Gigantor XL Solar Array | `panel_gigantor` | sat | 10.800 |
| 36 | HG-5 High Gain Antenna | `antenna_hg5` | sat | 2.520 |
| 36 | Probodobodyne OKTO | `probe_1v_octo` | sat | 3.600 |
| 36 | Z-100 Rechargeable Battery | `battery_z100` | sat | 0.180 |
| 1 | LV-909 Terrier | `engine_1v_methalox_terrier` | upper | 0.500 |
| 3 | FL-T800 | `fueltank_1v_inline_methalox_1x8` | upper | 13.500 |
...
| 2 | S1 SRB Kickback | `engine_srf_kickback` | boosters | 21.500 |

## Par rôle (rapide VAB)

### payload
- [ ] ×1 **Constellation Dispenser x36** (`payload_dispenser_36`)

### sat
- [ ] ×36 **Starlink-K V2 Bus** (`payload_starlink_v2`)
- [ ] ×36 **Gigantor XL Solar Array** (`panel_gigantor`)
- [ ] ×36 **HG-5 High Gain Antenna** (`antenna_hg5`)
- [ ] ×36 **Probodobodyne OKTO** (`probe_1v_octo`)
- [ ] ×36 **Z-100 Rechargeable Battery** (`battery_z100`)
...
### boosters
- [ ] ×2 **S1 SRB Kickback** (`engine_srf_kickback`)
