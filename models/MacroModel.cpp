...
QVector<MacroEntry> diabloIvMacros()
{
    return {
        ...
        { 6, QStringLiteral("Marche/Arret autoclicks (L1)"), QStringLiteral("L1"), QStringLiteral("mouse"), 0.0, 0, true, true, false },
...
QVector<MacroEntry> diabloIiiMacros()
{
    return {
        ...
        { 5, QStringLiteral("D3 — Marche/Arret (L1 souris)"), QStringLiteral("L1"), QStringLiteral("mouse"), 0.0, 0, true, true, false },
        { 6, QStringLiteral("D3 — Action L2"), QStringLiteral("L2"), QStringLiteral("mouse"), 8.0, 125, true, false, false }
    };
}
...
QVector<MacroEntry> genericMacros(const QString& prefix)
{
    return {
        ...
        { 5, prefix + QStringLiteral(" — Toggle L1"), QStringLiteral("L1"), QStringLiteral("mouse"), 0.0, 0, true, true, false },
        { 6, QStringLiteral("Elite M40 — L2"), QStringLiteral("L2"), QStringLiteral("mouse"), 10.0, 100, true, false, false }
    };
}
}
